(function () {
  ...
  MembraneTrait.membrane = { get: function () {
  ...
  this.MembraneTrait = Object.freeze(MembraneTrait);
  ...
  function PropertyMembrane(target, name) {
    ...
    if ('value' in property) {
      ...
      // If it's just a property generating accessors to it.
        ...
        descriptor.get = Getter.bind(target, name);
        descriptor.set = Setter.bind(target, name);
      }
    }
    return descriptor;
  }
